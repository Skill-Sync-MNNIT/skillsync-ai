...
import { LogOut, User as UserIcon, LayoutDashboard, Briefcase, ChevronDown, Menu, X, Sun, Moon } from 'lucide-react';
...
export const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg transition-colors duration-200">
            ...
            <>
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 transition-all duration-200"
                >
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl py-1.5 animate-scale-in origin-top-right z-50">
                    {/* User info header */}
          ...
          <div className="py-2">
            {navLinks.filter(l => l.show).map((link) => (
              <Link
                ...
                className="flex items-center gap-3 px-4 py-3 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors"
              >
                <link.icon size={16} className="text-slate-400" />
                {link.label}
              </Link>
            ...
            <button
              onClick={handleLogout}
              className="flex w-full items-center gap-3 px-4 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors border-t border-slate-100 dark:border-slate-800"
            >
              <LogOut size={16} />
              Sign Out
            </button>
